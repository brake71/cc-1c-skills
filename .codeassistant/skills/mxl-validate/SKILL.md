...
```powershell
python ".codeassistant/skills/mxl-validate/scripts/mxl-validate.py" -TemplatePath "Catalogs/Номенклатура/Templates/Макет"
python ".codeassistant/skills/mxl-validate/scripts/mxl-validate.py" -TemplatePath "src/МояОбработка/Templates/ПечатнаяФорма"
```
