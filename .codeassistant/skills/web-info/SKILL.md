...
```powershell
python ".codeassistant/skills/web-info/scripts/web-info.py" <параметры>
```
...
```powershell
# Статус по умолчанию
python ".codeassistant/skills/web-info/scripts/web-info.py"

# Указать путь к Apache
python ".codeassistant/skills/web-info/scripts/web-info.py" -ApachePath "C:\tools\apache24"
```
